"""
Models for the bookshelf app with enhanced security features.

This module contains:
1. CustomUser - Extended user model with additional fields
2. CustomUserManager - Custom manager for user creation
3. Book - Book model with custom permissions
"""
